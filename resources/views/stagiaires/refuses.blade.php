...
<nav class="bg-white border-gray-200">
    <div class="max-w-screen-xl flex items-center justify-between mx-auto p-4">
      ...
      <button onclick="history.back()" class="p-2 bg-transparent text-black-500 rounded-md flex items-center space-x-2 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
    ...
    <div class="container mx-auto max-w-screen-lg py-10">
      <form method="GET" action="{{ route('stagiaires.refuses') }}" class="flex justify-start max-w-xl mb-6 w-full">
                            ...
                            <td class="px-6 py-4 space-x-2">
                              <div class="flex space-x-4">
                                <a href={{ route('stagiaire.show', ['stagiaireId' => $stagiaire->id]) }} class="p-2 bg-blue-500 text-white rounded-md flex items-center space-x-2 hover:bg-blue-600">
                                  ...
                                  <form action="{{ route('stagiaire.delete', ['id' => $stagiaire->id]) }}" method="POST" style="display: inline;">
